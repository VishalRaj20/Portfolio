  ...
  const experiences = [
    {
      ...
      description: 'Completed a remote internship on a Microsoft-supported project under the Academic Partnership Grant 2024, focused on personalized travel planning using Geospatial Data and Large Language Models (LLMs).',
      achievements: [
      ...
      technologies: ['Python', 'LLMs', 'Prompt Engineering', 'Geospatial Data']
    }
